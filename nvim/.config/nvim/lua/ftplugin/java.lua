...
local config = {
  cmd = {
    ...
    '-jar',  vim.fn.expand("~/.local/share/nvim/mason/share/jdtls/plugins/org.eclipse.equinox.launcher_1.6.900.v20240613-2009.jar"),
  ...
  settings = {
    java = {
      ...
      -- Outras configurações específicas do JDTLS podem ser adicionadas aqui
    },
  },
}
